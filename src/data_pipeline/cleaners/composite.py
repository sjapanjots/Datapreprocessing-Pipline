"""Ordered composition of cleaning steps executed as a single unit."""
...
class CompositeCleaner(BaseCleaner):
    ...
    Ordering carries real meaning: labels are normalized before
    de-duplication so whitespace variants collapse correctly, and
    missing-value handling runs last so fills cannot manufacture false
    duplicates.
    """
